...
def draw_korean_text(draw, cx, cy, face_r, scale, font_path=None):
    ...
    try:
        if font_path and os.path.exists(font_path):
            ...
            # Buscar fuentes coreanas en el sistema
            for fp in [
...
if __name__ == "__main__":
    if "--install" in sys.argv:
        ...
        # Solo generar frames en directorio actual
        generate_frames(n_frames=24, output_dir="./ghost-eyes-frames")
        print("\nUsa --install para instalar en el sistema (requiere root)")
